...
class Play_toolbar(QToolBar):
    ...
    def initUI(self):
        ...
        self.button_shear = QAction(QIcon(os.path.join(ipath, '../icons/nu.png')), "shear", self)
        self.button_shear.setStatusTip("shear")
        self.button_poisson = QAction(QIcon(os.path.join(ipath, '../icons/shear.png')), "poisson", self)
